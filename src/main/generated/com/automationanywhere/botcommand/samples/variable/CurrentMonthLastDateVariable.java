...
public final class CurrentMonthLastDateVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(CurrentMonthLastDateVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final CurrentMonthLastDate command = new CurrentMonthLastDate();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    CurrentMonthLastDate command = new CurrentMonthLastDate();
