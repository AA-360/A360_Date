...
public final class CurrentMonthFisrtDateVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(CurrentMonthFisrtDateVariable.class);
