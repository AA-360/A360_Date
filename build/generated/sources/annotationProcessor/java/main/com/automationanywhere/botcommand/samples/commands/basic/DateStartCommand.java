...
public final class DateStartCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DateStartCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    DateStart command = new DateStart();
    ...
    try {
      command.init((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("Format"));Optional<Value> result = Optional.empty();
      return logger.traceExit(result);
    }
    catch (ClassCastException e) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.IllegalParameters","init"));
    }
