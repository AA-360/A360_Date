...
public final class LastMonthLastDateVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(LastMonthLastDateVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final LastMonthLastDate command = new LastMonthLastDate();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    LastMonthLastDate command = new LastMonthLastDate();
