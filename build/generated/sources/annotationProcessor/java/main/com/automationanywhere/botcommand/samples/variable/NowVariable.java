...
public final class NowVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(NowVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final Now command = new Now();
