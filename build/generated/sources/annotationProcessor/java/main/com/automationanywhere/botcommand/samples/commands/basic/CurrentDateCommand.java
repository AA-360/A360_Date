...
public final class CurrentDateCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(CurrentDateCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("Format")));
