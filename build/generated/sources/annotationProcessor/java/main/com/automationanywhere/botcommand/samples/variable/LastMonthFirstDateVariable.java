...
public final class LastMonthFirstDateVariable implements SystemVariable<StringValue> {
  private static final Logger logger = LogManager.getLogger(LastMonthFirstDateVariable.class);

  private static final Messages MESSAGES_GENERIC = MessagesFactory.getMessages("com.automationanywhere.commandsdk.generic.messages");

  private final LastMonthFirstDate command = new LastMonthFirstDate();
  ...
  public StringValue get(GlobalSessionContext globalSessionContext) {
    logger.traceEntry();
    LastMonthFirstDate command = new LastMonthFirstDate();
